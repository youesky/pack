...
async def pm_next_page(bot, query):
    ...
    btn.insert(0, [InlineKeyboardButton("🔗 ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ 🔗", url=script.HOW_TO_DOWNLOAD)])
...
async def pm_spoll_tester(bot, query):
    ...
    if files:
        ...
        k = await query.message.edit('Tʜɪs Sᴄᴇɴᴇᴘᴀᴄᴋ Nᴏᴛ Fᴏᴜɴᴅ Iɴ Dᴀᴛᴀʙᴀsᴇ')
...
async def pm_spoll_choker(msg):
    ...
    gs_parsed = []
    if not g_s:
        k = await msg.reply("I Cᴏᴜʟᴅɴ'ᴛ Fɪɴᴅ Aɴʏ Sᴄᴇɴᴇᴘᴀᴄᴋ Iɴ Tʜᴀᴛ Nᴀᴍᴇ", quote=True)
        await asyncio.sleep(10)
