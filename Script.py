...
I Cᴀɴ Pʀᴏᴠɪᴅᴇ Sᴄᴇɴᴇᴘᴀᴄᴋ Fᴏʀ Yᴏᴜ Jᴜsᴛ Aᴅᴅ Mᴇ Iɴ Yᴏᴜʀ Gʀᴏᴜᴘ Oʀ Jᴏɪɴ Oᴜʀ Gʀᴏᴜᴘ</b>"""
...
• /clear_junk_group - Cʟᴇᴀʀ Aᴅᴅ Rᴇᴍᴏᴠᴇᴅ Gʀᴏᴜᴘ Oʀ Dᴇᴀᴄᴛɪᴠᴀᴛᴇᴅ Gʀᴏᴜᴘs Oɴ Dʙ"""
    ...
    NO_SUDO_TXT = """Sᴏʀʀʏ, Yᴏᴜʀ Nᴏᴛ Aᴜᴛʜᴏʀɪsᴇᴅ Tᴏ Uᴘʟᴏᴀᴅ Sᴄᴇɴᴇᴘᴀᴄᴋs 📤.
Cᴏɴᴛᴀᴄᴛ @rabeeh_rc Fᴏʀ Uᴘʟᴏᴀᴅɪɴɢ Sᴄᴇɴᴇᴘᴀᴄᴋs Aɴᴅ Sᴛᴀʀᴛ Eᴀʀɴɪɴɢ."""

    SUDO_TXT ="""/newpack - create a new scenepack
/mypacks - edit your scenepacks
/deletepack - delete a scenepack"""
...
ꜱʜᴀʀᴇ & ꜱᴜᴩᴩᴏʀᴛ, ʀᴇqᴜᴇꜱᴛ ʏᴏᴜ ᴡᴀɴᴛᴇᴅ sᴄᴇɴᴇᴘᴀᴄᴋ"""
...
🌟 Rᴀᴛɪɴɢ: <a href={url}/ratings>{rating}</a>/10"""
    ...
    HOW_TO_DOWNLOAD = "https://t.me/ScenepackOfficial/48"
